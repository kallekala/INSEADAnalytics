...
<br>
2. 
cumulative: sum(StockReturns[,2]) -> 5.755208
Avg: mean(StockReturns[,2]) -> 0.001482196
Stand dev of returns:
sd(StockReturns[,2]) -> 0.02424934
<br>
3. Add “YHOO”
<br>
...
pf <- apply(transposedData, 2, mean)
pnl_plot(pf)
<br>
```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE,results='asis',fig.align='center', fig.height=4,fig.width= 6, fig=TRUE}
transposedData <- t(StockReturns)
...
**Your Answers here:**
<br>
1. Date is already set to 2001-01-01 in the dataset: 
